...
/**
 *public static void main(String[] args) {  - эта строка является объявлением метода main.
 *main это точка входа, начальный публичный, статичный метод, которая принимает в себя из коммандной строки массив аргументов типа string и ничего не возвращает и,
 *если программа состоит из нескольких классов их вызов осуществляется из метода main.
*/
